        ...
        stage('Test') {
            ...
            post {
                always {
                    ...
                    publishCoverage adapters: [jacocoAdapter(mergeToOneReport: true, path: '**/build/reports/kover/xml/*.xml')], sourceDirectories: [[path: '**/src/main/kotlin'], [path: '**/src/main/java']], sourceFileResolver: sourceFiles('STORE_LAST_BUILD')
                }
            }
        }
        stage('Deploy') {
