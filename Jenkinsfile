        ...
        stage('Test') {
            ...
            post {
                always {
                    ...
                    publishCoverage adapters: [jacocoAdapter(mergeToOneReport: true, path: '**/build/reports/kover/xml/*.xml')], sourceDirectories: [[path: '**/src']], sourceFileResolver: sourceFiles('STORE_LAST_BUILD')
                }
            }
        }
        stage('Deploy') {
