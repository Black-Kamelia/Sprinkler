...
import com.kamelia.sprinkler.binary.decoder.core.Decoder.State
import com.kamelia.sprinkler.binary.decoder.core.Decoder.State.Done
import com.kamelia.sprinkler.binary.decoder.core.Decoder.State.Error
 ...
 * @see DecoderDataInput
 * @see State
 */
interface Decoder<out T> {

    /**
     * Tries to decode an object of type [T] from the given [DecoderDataInput] [input].
     *
